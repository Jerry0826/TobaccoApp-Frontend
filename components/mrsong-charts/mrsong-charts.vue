<template>
	<view v-if="showChart" class="mrsong-charts">
		...
		<view class="charts-box">
			...
			<qiun-data-charts :opts="opts" type="column" :chart-data="currentData" background="none" :animation="true" :ontouch="true" />
		</view>
	</view>
</template>
<script>
			...
			// } else {
				return {
					...
					series: [
						{
							name: '评论数',
							data: [27, 127, 96, 121, 103, 52,37,56,61,37,11,12,3]
						},
						{
							name: '好评数',
